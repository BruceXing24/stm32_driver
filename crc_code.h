...
#ifndef HEIMAROBOTV4_CRC_CODE_H
#define HEIMAROBOTV4_CRC_CODE_H
 ...
 * 传入要校验的数据,以及长度
 */
int generateCRC(uint8_t Frame[], int Length)
{
    uint8_t CRCHi = 0xFF;
    uint8_t CRCLo = 0xFF;
    int iIndex = 0;
    ...
    for (int i = 0; i < Length; i++)
    {
        ...
        CRCHi = (uint8_t)(CRCLo ^ aucCRCHi[iIndex]);
